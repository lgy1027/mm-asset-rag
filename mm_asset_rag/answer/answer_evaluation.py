...
from ..core.paths import get_answer_eval_report, get_asset_index_path
from ..core.schema import SearchHit
from ..core.settings import get_settings
from ..eval.evaluation_reporting import build_report
...
def run_answer_eval(
    ...
    *,
    ...
    - ``answer_fn`` → ``mm_asset_rag.answer.answer.llm_answer``
...
def _citation_metrics(
    ...
    from ..core.metrics import _normalize_id
